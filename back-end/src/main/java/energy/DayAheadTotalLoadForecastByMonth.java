...
public class DayAheadTotalLoadForecastByMonth {
	...
	public DayAheadTotalLoadForecastByMonth(String areaName, String areaTypeCode, String mapCode, String resolutionCode,
			int year, int month, float dayAheadTotalLoadForecastByMonthValue) {
		super();
		AreaName = areaName;
