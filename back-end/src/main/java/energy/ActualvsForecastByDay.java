...
@JsonPropertyOrder({ "source", "dataset", "areaName", "areaTypeCode", "mapCode", "resolutionCode", "year", "month",
		"day", "dayAheadTotalLoadForecastByDayValue", "actualTotalLoadByDayValue" })
public class ActualvsForecastByDay {
	...
	public ActualvsForecastByDay(String areaName, String areaTypeCode, String mapCode, String resolutionCode, int year,
			int month, int day, float dayAheadTotalLoadForecastByDayValue, float actualTotalLoadByDayValue) {
		super();
		AreaName = areaName;
