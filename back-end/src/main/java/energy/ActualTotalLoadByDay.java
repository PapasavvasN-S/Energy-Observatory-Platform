...
@JsonPropertyOrder({ "source", "dataset", "areaName", "areaTypeCode", "mapCode", "resolutionCode", "year", "month",
		"day", "actualTotalLoadByDayValue" })
public class ActualTotalLoadByDay {
	...
	public ActualTotalLoadByDay(String areaName, String areaTypeCode, String mapCode, String resolutionCode, int year,
			int month, int day, float actualTotalLoadByDayValue) {
		super();
		AreaName = areaName;
