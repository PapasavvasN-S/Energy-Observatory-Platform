...
@JsonPropertyOrder({ "source", "dataset", "areaName", "areaTypeCode", "mapCode", "resolutionCode", "year", "month",
		"day", "dayAheadTotalLoadForecastByMonthValue", "actualTotalLoadByMonthValue" })
public class ActualvsForecastByMonth {
	...
	public ActualvsForecastByMonth(String areaName, String areaTypeCode, String mapCode, String resolutionCode,
			int year, int month, float dayAheadTotalLoadForecastByMonthValue, float actualTotalLoadByMonthValue) {
		super();
		AreaName = areaName;
