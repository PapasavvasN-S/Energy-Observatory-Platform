...
@JsonPropertyOrder({ "source", "dataset", "areaName", "areaTypeCode", "mapCode", "resolutionCode", "year", "month",
		"day", "dateTimeUTC", "dayAheadTotalLoadForecastValue", "updateTimeUTC" })
public class DayAheadTotalLoadForecast {
	...
	public DayAheadTotalLoadForecast(String areaName, String areaTypeCode, String mapCode, String resolutionCode,
			int year, int month, int day, String dateTimeUTC, float dayAheadTotalLoadForecastValue,
